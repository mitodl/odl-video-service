...
export const makeVideoThumbnail = (
  videoKey: string = casual.uuid,
  encoding: string = ENCODING_ORIGINAL
) => ({
  id:            videoThumbnailId(),
...
export const makeVideo = (
  ...
  videothumbnail_set: [makeVideoThumbnail(videoKey)],
  videosubtitle_set:  [makeVideoSubtitle(videoKey)],
...
export const makeVideos = (
  n: number,
  collectionKey: string = casual.uuid
): Array<Video> => _.times(n, () => makeVideo(casual.uuid, collectionKey))
