...
- Use Keycloak token claims for group lookups and add collection owner migration
- Derive KEYCLOAK_SERVER_URL and KEYCLOAK_REALM from SOCIAL_AUTH token URL
