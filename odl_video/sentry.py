...
def init_sentry(*, dsn, environment, version, log_level):
    ...
    sentry_sdk.init(
        ...
        # covers the bodies posted to the Django and DRF views: collection,
        # video and subtitle edits, Dropbox upload requests and transcode-job
        # callbacks.  Set explicitly so the choice is findable here rather
